...
const LoginPage = () => {
    ...
    return (
        <div>
            <Box sx={{ display:"flex",alignContent:"center",alignItems:"center",flexWrap:"wrap", height: "7vh", width: "100%", backgroundColor: theme.palette.primary.main,paddingLeft:"1.5rem"}}>
                <ArrowBackOutlined sx={{ color:"#fff",marginRight:"1.5rem"}} />
                <Typography fontFamily={"Ubuntu,sans-serif"} variant="h5" color={"#fff"}>Iniciar sesión</Typography>
            </Box>
